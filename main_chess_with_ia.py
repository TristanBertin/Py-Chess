...
from decision_depth_3 import decision_depth_2 as decision
...
while run:
    ...
    if white_turn == 0 and (white_mate==False and black_mate==False):
        max_score, index_piece, final_position, index_white_to_remove = decision(alive_pieces_black, alive_pieces_white)
        ...
        if index_white_to_remove != None:
            alive_pieces_white.pop(index_white_to_remove)
        white_turn = 1
